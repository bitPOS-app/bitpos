      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">Bitcoin point of sale and NFC card shop. Open source under AGPL-3.0, for merchants on the Lightning Network.</p>
          </div>
          <div>
