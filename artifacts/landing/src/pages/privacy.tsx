    ...
    <BlueprintShell>
      <main className="relative z-20 mx-auto max-w-[760px] px-5 sm:px-8 pb-20 pt-10">
        ...
        <p className="mt-8 font-['Ubuntu'] text-[15px] leading-relaxed text-white/65">
          bitPOS is a hosted service. Account data lives on our servers. Lightning funds live in the
          wallet you connect. This policy explains what we store, why, and what we do not do with it.
        </p>
        ...
        <Sec n="01" title="What We Store">
          ...
          <ul className="mt-2 space-y-2">
            ...
            <Li><><strong className="text-white/85">Wallet connection:</strong> if you connect a NIP-47 wallet, the connection URL is stored encrypted at rest (AES-256-GCM). bitPOS uses it to create invoices and send payments on your behalf. We do not hold your node keys. If you use an optional bootstrap wallet, that provider has its own custody terms.</></Li>
            <Li><><strong className="text-white/85">Transaction history:</strong> payments you receive or send through bitPOS - amount, direction, timestamp, payment hash, counterpart where available, and status.</></Li>
        ...
        <Sec n="05" title="Third-Party Services">
          ...
          <ul className="mt-2 space-y-2">
            <Li><><strong className="text-white/85">NIP-47 wallet / Alby:</strong> payments settle through the wallet you connected. If that wallet is Alby or another hosted NWC provider, their privacy policy applies to that wallet.</></Li>
