  ...
  return (
    <BlueprintShell>
      ...
      <Section>
        ...
        <FeatureBullets
          items={[
            ...
            "Connect your own NIP-47 wallet - bitPOS never holds your keys",
      ...
      <Section>
        ...
        <TagRow tags={["AGPL-3.0", "Lightning Network", "LNURL", "NIP-47", "Non-custodial", "Instant settlement"]} />
      </Section>
      ...
      <FinalCTA
        ...
        note="1% on incoming payments - outgoing is free"
      />
    </BlueprintShell>
  );
}
