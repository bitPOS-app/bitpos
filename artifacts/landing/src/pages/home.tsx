...
import { ArrowRight, Bitcoin, CreditCard, Shield, Zap, QrCode, Lock, BarChart3, Github, Download, Smartphone, ShoppingCart, Package, CheckCircle2, Code, ShieldCheck, GitPullRequest } from "lucide-react";
          ...
          >
            <div className="space-y-4">
              ...
              <motion.p variants={fadeInUp} className="max-w-[600px] mx-auto text-lg text-muted-foreground md:text-xl leading-relaxed">
                Run your shop on Lightning. Issue tap-to-pay Bolt Cards for your customers. Open source, audit-friendly, no bank required.
              </motion.p>
            </div>
            ...
            {[
              {
                ...
                title: "Point of Sale",
                description: "Calculate totals, take orders, generate Lightning invoices. Designed for one-handed counter use."
              },
              {
                icon: <CreditCard className="h-8 w-8" />,
                title: "Bolt Card NFC",
                description: "Issue NTAG424 DNA cards your customers tap to pay. Sub-second settlement, no app needed at the till."
              },
              {
                icon: <Lock className="h-8 w-8" />,
                title: "Custodial Wallet",
                description: "We run the Lightning node so you don't. Funds settle instantly, available the moment a payment confirms."
              },
              {
                icon: <BarChart3 className="h-8 w-8" />,
                title: "Rich Analytics",
                description: "Daily, weekly, monthly revenue. Top items, busiest hours, exportable as CSV."
              },
              {
                icon: <Shield className="h-8 w-8" />,
                title: "Staff Accounts",
                description: "PIN-protected staff can take payments and see their shift. They can't touch settings or move funds out."
              },
              {
                icon: <Bitcoin className="h-8 w-8" />,
                title: "Auto-Conversion",
                description: "Price items in 40+ fiat currencies. Customers pay in sats, you see your local total."
              }
            ].map((feature, i) => (
              <motion.div
                key={i}
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            ...
            <p className="max-w-[640px] text-muted-foreground md:text-lg">
              We sell card products and also publish every line of code that runs them.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "AGPL-3.0 source on GitHub. Frontend, backend, card writer, infra config. No proprietary backdoors.",
                href: "https://github.com/bitPOS-app/bitpos",
                cta: "Browse the repo",
              },
              {
                ...
                description: "Every page shows the exact build commit in the footer. Click it to see the source that produced it.",
                href: "/api/version",
              ...
              },
              {
                ...
                description: "Issues, pull requests, and discussions are public. Ship a fix, propose a feature, or fork it.",
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground">
                bitPOS is a custodial Lightning service - so you don't have to run a node. No subscriptions, no hidden costs.
              </p>
      ...
      <section className="py-24 md:py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <motion.div 
            ...
            className="flex flex-col items-center text-center space-y-8 max-w-3xl mx-auto"
          >
            <h2 className="text-4xl font-bold tracking-tight sm:text-5xl">Open a tab the bank can't close.</h2>
            <p className="text-xl text-muted-foreground">
              Take payments tonight. The terminal runs in any browser. The cards ship in a week.
            </p>
