...
interface PinPadProps {
  ...
  maxLength?: number;
  className?: string;
  /** Large variant for POS terminal / fullscreen PIN entry */
  large?: boolean;
  disabled?: boolean;
}
...
export default function PinPad({ value, onChange, maxLength = 6, className, large = false, disabled = false }: PinPadProps) {
