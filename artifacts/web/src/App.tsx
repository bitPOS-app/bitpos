...
import CardDesignerPage from "@/pages/business/CardDesignerPage";
import CardStudioPage from "@/pages/business/CardStudioPage";
...
function AppRouter() {
  return (
    <Routes>
      ...
      <Route path="/business/card-designer" element={
        <ProtectedRoute><CardDesignerPage /></ProtectedRoute>
      } />
      <Route path="/business/card-studio" element={
        <ProtectedRoute><CardStudioPage /></ProtectedRoute>
      } />
