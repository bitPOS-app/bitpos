...
function AppRouter() {
  return (
    <Routes>
      ...
      <Route path="/business/payroll" element={<ProtectedRoute><Navigate to="/business" replace /></ProtectedRoute>} />
      <Route path="/business/invoices" element={<ProtectedRoute><Navigate to="/business" replace /></ProtectedRoute>} />
      ...
      <Route path="/admin/:id" element={<AdminPaymentsPage />} />
