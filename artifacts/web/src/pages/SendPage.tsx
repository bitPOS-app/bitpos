...
export default function SendPage() {
  ...
  const feeSats = isInNetwork ? 0 : Math.ceil(amountSats * 0.03);
          ...
          {amountSats > 0 && (
            <div className="bg-card border border-border rounded-xl px-4 py-3 space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className={cn("font-mono-nums", isInNetwork ? "text-primary" : "")}>
                  {isInNetwork ? "No fee (in-network)" : `${feeSats.toLocaleString()} sats (3%)`}
                </span>
              </div>
              {!hasBalance && (
            ...
            {isBolt11 && decoded ? (
              <>
                ...
                <div className="flex justify-between">
                  ...
                  <div className="text-right">
                    <p className="font-mono-nums">{feeSats > 0 ? `${feeSats.toLocaleString()} sats (3%)` : "-"}</p>
                    {feeSats > 0 && formatFiat(feeSats) && (
                      <p className="text-xs text-muted-foreground">{formatFiat(feeSats)}</p>
                    )}
                  </div>
                </div>
              ...
              <>
                ...
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Fee</span>
                  <span className={cn("font-mono-nums", isInNetwork ? "text-primary" : "")}>
                    {isInNetwork ? "No fee" : `${feeSats.toLocaleString()} sats`}
                  </span>
                </div>
                <div className="flex justify-between font-semibold border-t border-border pt-3">
                  <span>Total</span>
