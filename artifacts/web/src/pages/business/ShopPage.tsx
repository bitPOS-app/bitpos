          ...
          <div className="space-y-4">
              ...
              <div className="bg-card border border-border rounded-2xl p-4 space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span>
                    ...
                    <FiatHint sats={eurCentsToSatsDisplay(quote.shippingEurCents, quote.btcEurRate)} />
                    {quote.quantity > 1 && (
                ...
                <div className="border-t border-border pt-2 flex justify-between font-semibold">
                  <span>Total</span>
                  <span className="text-primary">{satsLabel(quote.totalSats)}<FiatHint sats={quote.totalSats} /></span>
                </div>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                {quote ? `Pay ${satsLabel(quote.totalSats)} via Lightning` : "Calculating price..."}
              </button>
              {quote && quote.userBalanceSats >= quote.totalSats && (
                <button
                  type="button"
                  disabled={submitting}
                  onClick={() => {
