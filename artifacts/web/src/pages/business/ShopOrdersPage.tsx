...
import { ArrowLeft, ChevronRight, Loader2, RefreshCw, ShoppingBag } from "lucide-react";
...
function designLabel(designId?: string) {
              ...
              >
                <div className="flex-1 min-w-0">
                  ...
                  <p className="font-medium text-sm">
                    {order.quantity > 1 ? `${order.quantity}× ` : ""}{designLabel(order.designId)}
                  </p>
