...
import { Monitor, Users, FileText, BarChart2, Briefcase, ShoppingBag, Cpu } from "lucide-react";
...
const modules = [
  ...
  { id: "card-shop", label: "Card Shop", icon: ShoppingBag, href: "/business/card-shop", desc: "Order and design Bolt Cards - powered by maekob" },
