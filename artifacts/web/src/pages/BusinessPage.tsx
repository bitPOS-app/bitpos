...
import { Monitor, BarChart2, Briefcase, ShoppingBag, Cpu } from "lucide-react";
...
const modules = [
  ...
  { id: "card-shop", label: "Card Shop", icon: ShoppingBag, href: "/business/card-shop", desc: "Order Bolt Cards - MAEKOB" },
  { id: "reports", label: "Activity", icon: BarChart2, href: "/business/reports", desc: "Cash flow from wallet history" },
];
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center space-y-6 py-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-1 max-w-xs mx-auto">
              Accept Lightning payments and manage your shop
            </p>
          </div>
