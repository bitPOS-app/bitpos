 ...
 * Copied verbatim from bolt-nfc-android-app/src/utils/Cmac.js (working reference)
 */
...
ext.const_Zero = new WordArray.init([
  0x00000000, 0x00000000, 0x00000000, 0x00000000,
]);
ext.const_One = new WordArray.init([
  0x00000000, 0x00000000, 0x00000000, 0x00000001,
]);
ext.const_Rb = new WordArray.init([
  0x00000000, 0x00000000, 0x00000000, 0x00000087,
]);
ext.const_Rb_Shifted = new WordArray.init([
  0x80000000, 0x00000000, 0x00000000, 0x00000043,
]);
ext.const_nonMSB = new WordArray.init([
